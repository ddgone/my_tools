...
func (a *App) GetPythonToolchainTaskState() *PythonToolchainTaskState {
	return convertPythonToolchainTaskState(a.getPythonToolchainTaskState())
}

func (a *App) StartPreparePythonToolchainEnvironment() (*PythonToolchainTaskState, error) {
	task, err := a.startPreparePythonToolchainTask()
	if err != nil {
		return nil, err
	}
...
func (a *App) StartInstallPythonDependencies() (*PythonToolchainTaskState, error) {
	task, err := a.startInstallPythonDependenciesTask()
	if err != nil {
		return nil, err
	}
	return convertPythonToolchainTaskState(task), nil
...
func (a *App) CancelActivePythonToolchainTask() error {
	return a.cancelPythonToolchainTask()
}
...
func convertPythonToolchainTaskState(task *PythonToolchainTask) *PythonToolchainTaskState {
	if task == nil {
		return nil
	}
