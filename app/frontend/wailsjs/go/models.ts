...
export namespace runtime {
	...
	export class RemotePathEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new RemotePathEntry(source);
	    }
	...
	export class RemotePathBrowseResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new RemotePathBrowseResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.message = source["message"];
	        this.entries = this.convertValues(source["entries"], RemotePathEntry);
	    }
