...
func convertRustToolchainTaskState(task *shared.RustToolchainTask) *RustToolchainTaskState {
	if task == nil {
		return nil
	}
...
func (m *Manager) StartInstallRustCargoZigbuild() (*RustToolchainTaskState, error) {
	task, err := m.startInstallRustCapabilityTask("cargo-zigbuild")
	if err != nil {
		return nil, err
	}
...
func (m *Manager) StartInstallRustTargets() (*RustToolchainTaskState, error) {
	task, err := m.startInstallRustCapabilityTask("targets")
	if err != nil {
		return nil, err
	}
	return convertRustToolchainTaskState(task), nil
...
func (m *Manager) GetRustToolchainState() (*RustToolchainState, error) {
...
func (m *Manager) CheckRustToolchainEnvironment() (*RustToolchainState, error) {
	state, err := toolchain.GetRustState()
	if err != nil {
		return nil, err
	}
...
func (m *Manager) SaveRustToolchainConfig(cfg RustToolchainConfig) (*RustToolchainState, error) {
...
func (m *Manager) ListOfficialRustReleases() ([]RustOfficialRelease, error) {
...
func (m *Manager) ListOfficialZigReleases() ([]ZigOfficialRelease, error) {
...
func (m *Manager) DeleteManagedRustToolchainEnvironment() (*RustToolchainState, error) {
...
func (m *Manager) GetRustToolchainTaskState() *RustToolchainTaskState {
	return convertRustToolchainTaskState(m.getRustToolchainTaskState())
}

func (m *Manager) StartInstallRustToolchain(req InstallRustToolchainRequest) (*RustToolchainTaskState, error) {
	task, err := m.startInstallRustToolchainTask(req)
	if err != nil {
		return nil, err
	}
	return convertRustToolchainTaskState(task), nil
...
func (m *Manager) CancelActiveRustToolchainTask() error {
	return m.cancelRustToolchainTask()
}
