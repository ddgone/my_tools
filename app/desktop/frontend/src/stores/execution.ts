...
import { CancelExecution, ListTasks, StartLocalExecution } from '../../wailsjs/go/main/App'
import type { ExecutionRequest, ExecutionTask, TaskLogEvent } from '@/types/workbench'
